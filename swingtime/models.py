...
class Event(EventBase):
    event_type = models.ForeignKey('swingtime.EventType', verbose_name=_('event type'))
...
def event_creation_factory(event_cls, event_type_cls):
    ...
    def inner_create_event(
        ...
        **rrule_params
        ...
        if note is not None:
            warnings.warn('`note` will be removed shortly', PendingDeprecationWarning, stacklevel=2)
...
create_event = event_creation_factory(Event, EventType)
